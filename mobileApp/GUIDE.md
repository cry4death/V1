...
> **Путь:** `mobileApp/` — мобильное приложение Flutter для пациентов клиники «Маяк Здоровья».  
> **Backend:** Laravel API `site/` → префикс **`/api/v1`**.  
> **Стек:** Flutter 3.10+ · Dart 3.10+ · Riverpod 2 · GoRouter 17 · Dio 5 · Firebase FCM · local_auth · flutter_secure_storage.
...
> **Как учиться по этому GUIDE:** сначала [§14](#14-последовательный-разбор-кода-учебник) (15 шагов с кодом построчно), затем [§15](#15-остальные-файлы-lib--код-и-пояснения) (все остальные Dart-файлы), справочно — [§6](#6-lib--каждый-dart-файл-85).
