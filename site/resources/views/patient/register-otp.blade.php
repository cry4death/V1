    ...
    <div class="container" style="max-width: 560px; padding: 3rem 1rem;">
        ...
        <form method="post" action="{{ route('patient.register.complete') }}">
            ...
            <div style="display: flex; gap: 0.75rem;">
                <a href="{{ route('patient.register.phone') }}" class="cabinet-btn cabinet-btn--ghost" style="flex: 1; justify-content: center;">Изменить номер</a>
                <button type="submit" class="cabinet-btn cabinet-btn--primary" style="flex: 1;">Завершить регистрацию</button>
            </div>
        </form>
    </div>
@endsection
