...
@section('content')
    <div class="container" style="max-width: 560px; padding: 3rem 1rem;">
        ...
        <form method="post" action="{{ route('patient.register.request-otp') }}" id="reg-phone-form">
            @csrf
            ...
            <div style="display: flex; gap: 0.75rem; margin-top: 0.25rem;">
                <a href="{{ route('patient.register.profile') }}" class="cabinet-btn cabinet-btn--ghost" style="flex: 1; justify-content: center;">← Назад</a>
...
(function () {
    ...
    var form = document.getElementById('reg-phone-form');
